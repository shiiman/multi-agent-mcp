...
agents.json の保存/読み込み/同期、および特定ロールのエージェント検索を提供する。
managers 配下に配置し、tools からは互換ファサード経由で参照する。
"""
...
from src.managers.git_utils import resolve_main_repo_root
from src.managers.project_registry import (
    ensure_session_id,
