...
_SYMBOL_TO_MODULE = {
    ...
    "InvalidConfigError": "src.managers.project_registry",
    "OWNER_WAIT_ALLOWED_TOOLS": "src.tools.helpers_permissions",
    "_get_agent_registry_dir": "src.managers.project_registry",
    "_get_agents_file_path": "src.managers.agent_persistence",
    "_get_from_config": "src.managers.project_registry",
    "_get_global_mcp_dir": "src.managers.project_registry",
    ...
    "delete_agents_file": "src.managers.agent_persistence",
    ...
    "ensure_session_id": "src.managers.project_registry",
    "find_agents_by_role": "src.managers.agent_persistence",
    ...
    "get_enable_git_from_config": "src.managers.project_registry",
    "get_gtrconfig_manager": "src.tools.helpers_managers",
    "get_mcp_tool_prefix_from_config": "src.managers.project_registry",
    "get_owner_wait_state": "src.tools.helpers_permissions",
    "get_project_root_from_config": "src.managers.project_registry",
    "get_project_root_from_registry": "src.managers.project_registry",
    "get_session_id_from_config": "src.managers.project_registry",
    "get_session_id_from_registry": "src.managers.project_registry",
    "get_worktree_manager": "src.tools.helpers_managers",
    "load_agents_from_file": "src.managers.agent_persistence",
    ...
    "remove_agent_from_file": "src.managers.agent_persistence",
    "remove_agent_from_registry": "src.managers.project_registry",
    "remove_agents_by_owner": "src.managers.project_registry",
    ...
    "save_agent_to_file": "src.managers.agent_persistence",
    "save_agent_to_registry": "src.managers.project_registry",
    "search_memory_context": "src.tools.helpers_managers",
    "sync_agents_from_file": "src.managers.agent_persistence",
